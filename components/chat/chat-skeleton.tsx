...
export default function ChatSkeleton() {
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)] bg-slate-50">
      ...
      {/* Top bar skeleton */}
      <div className="shrink-0 bg-white border-b border-slate-200 px-4 md:px-6 py-3 flex items-center gap-4">
      ...
      <div className="flex-1 px-4 md:px-6 py-6 space-y-6">
        ...
        <div className="flex gap-3">
          <div className="size-8 rounded-full bg-slate-200 animate-pulse shrink-0 mt-1" />
          <div className="space-y-2 max-w-sm">
            <div className="h-10 w-64 bg-white border border-slate-200 animate-pulse rounded-2xl rounded-tl-sm" />
          </div>
        </div>
        {/* User bubble */}
        <div className="flex gap-3 flex-row-reverse">
          <div className="size-8 rounded-full bg-slate-200 animate-pulse shrink-0 mt-1" />
          <div className="space-y-2 max-w-sm">
            <div className="h-10 w-48 bg-violet-100 animate-pulse rounded-2xl rounded-tr-sm" />
          </div>
        </div>
        ...
        <div className="flex gap-3">
          ...
          <div className="space-y-3 flex-1 max-w-lg">
            <div className="h-16 bg-white border border-slate-200 animate-pulse rounded-2xl rounded-tl-sm" />
            <div className="h-2.5 w-28 bg-slate-100 animate-pulse rounded" />
      ...
      <div className="shrink-0 bg-white border-t border-slate-200 px-4 md:px-6 py-4">
        <div className="flex items-end gap-3">
          <div className="flex-1 h-11 bg-slate-100 animate-pulse rounded-xl" />
          <div className="size-11 bg-violet-200 animate-pulse rounded-xl shrink-0" />
        </div>
        <div className="h-2 w-56 bg-slate-100 animate-pulse rounded mt-2 mx-auto" />
      </div>
