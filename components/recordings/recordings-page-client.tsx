            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="rounded-[24px] border border-slate-200 bg-white p-4 shadow-sm">
                <div className="flex items-center justify-between gap-4 text-xs font-medium text-slate-500">
                  <span>
                    {windowRange ? formatShortTime(windowRange.start) : "00:00"}
                  </span>
                  ...
                  <span>
                    {windowRange ? formatShortTime(windowRange.end) : "23:59"}
                  </span>
                </div>
                ...
                >
                  ...
                  {markers.map((marker) => {
                    ...
                    const span =
                      windowRange.end.getTime() - windowRange.start.getTime();
                    const position =
                ...
                <div className="mt-4 space-y-4">
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <p className="mt-1 text-sm text-slate-500">
                      {isIncidentReplay
                        ? "Incident replay focus window"
                        : "Full-day recording scan"}
                    </p>
                  </div>
